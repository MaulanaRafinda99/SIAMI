...
class model_admin extends CI_Model
{
	...
	public function get_komponen_sndikti()
	{
		return $this->db->get('sndikti')->result_array();
	}
	...
	public function get_data_ami()
	{
		return $this->db->get('data_ami')->result_array();
	}

	public function get_siklus()
	{
		return $this->db->get('siklus')->result_array();
	}

	public function get_data_ami2($where)
	{
		return $this->db->get_where('data_ami', $where)->result_array();
	}

	public function get_jadwal_audit() {
		return $this->db->get('jadwal_audit')->result_array();
	}

	public function pilih_data($id_siklus = null, $id_prodi = null)
	{
		if ($id_siklus !== null) {
